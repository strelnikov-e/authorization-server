...
public class ControllerTest {
    ...
    private final String authorizeUrlPattern = "http://localhost:9000/auth/realms/baeldung/protocol/openid-connect/auth?response_type=code&client_id=fooClient&scope=%s&redirect_uri=" + redirectUrl;
    private final String tokenUrl = "http://localhost:9000/auth/realms/baeldung/protocol/openid-connect/token";
    private final String resourceUrl = "http://localhost:8090/resource-server-jwt/foos";


    @Test
    public void givenUserWithReadScope_whenArticlesResource_thenSuccess() {
